...
#The script performs GLMnet analysis, evaluating all different models depicted in Supplemental Figure 12A. It also plots significant features from those models in Supplemental Figure 12B. 
#Additionally, it plots violin plots of normalized counts for three examples of significant features that differ
#between immune hot and cold, as shown in Supplemental Figure 12C.
...
all.equal(colnames(gsva_TLS_gene), Ordered_pheno$patient)
Ordered_pheno<-cbind(Ordered_pheno, t(gsva_TLS_gene))
...
####Test statistics for shuffled vs unshuffled model 
 ...
 #           Plotting Supplemental figure 12C
 ...
 #The command to render is rmarkdown::render("Script_2_TCGA.R")
